...
export default function ReportDashboard({ churchProfile }) {
  ...
  const churchName = churchProfile?.churchName || 'Central Cathedral Headquarters';
  const pastorName = churchProfile?.pastorName || 'Rev. Senior Pastor';
  const branchType = churchProfile?.branchType || 'Main Campus HQ';
  ...
  // Trigger Print from inside Preview
  ...
  return (
    <div className="space-y-6 animate-fadeIn pb-12 w-full select-none text-slate-200">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-white/10 pb-5">
          <div>
            <div className="flex items-center gap-2">
              <span className="px-3 py-1 rounded-full bg-orange-500/10 text-orange-400 border border-orange-500/20 text-[10px] font-bold uppercase tracking-wider flex items-center gap-1.5 shadow-[0_0_12px_rgba(255,107,0,0.2)]">
                <Sparkles size={12} className="text-orange-400" />
                Church Executive Audit & PDF Engine
              </span>
            </div>
            <h1 className="text-2xl font-black text-white mt-1.5 flex items-center gap-2">
              <FileText className="text-orange-400" size={26} />
              <span>Church Analytics & Reports Centre</span>
            </h1>
            <p className="text-xs text-slate-400 mt-1">
              Live document generator with official digital seal, print preview, and executive exports.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            <select
              ...
              className="bg-slate-900 border border-white/10 rounded-2xl px-3.5 py-2 text-xs text-white font-bold focus:outline-none cursor-pointer"
            >
            ...
            <button
              ...
              className="px-4 py-2 bg-emerald-600/20 hover:bg-emerald-600/30 text-emerald-300 border border-emerald-500/30 rounded-2xl text-xs font-bold shadow-lg flex items-center gap-1.5 cursor-pointer transition-all active:scale-95"
            >
              <Download size={14} />
            ...
            <button
              ...
              className="px-4 py-2 bg-gradient-to-r from-[#ff6b00] to-[#f43f5e] hover:from-[#ff7b1a] hover:to-[#f54f6e] text-white rounded-2xl text-xs font-bold shadow-lg flex items-center gap-1.5 cursor-pointer transition-all active:scale-95"
            >
              <Eye size={14} />
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-2.5">
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] font-mono text-orange-400 font-bold">+12.4%</span>
            </div>
            <div className="text-xs font-bold mt-2">1. Attendance</div>
            <span className="text-[9px] text-slate-500">Service Turnout</span>
          </button>
          ...
          >
            ...
            <span className="text-[9px] text-slate-500">Believer Census</span>
          </button>
          ...
          >
            ...
            <span className="text-[9px] text-slate-500">Seeker Funnel</span>
          </button>
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] font-mono text-emerald-400 font-bold">₹1.42L</span>
            </div>
            <div className="text-xs font-bold mt-2">4. Treasury</div>
            <span className="text-[9px] text-slate-500">Giving & Expenses</span>
          </button>
          ...
          >
            ...
            <span className="text-[9px] text-slate-500">Attestations</span>
          </button>
        </div>

        {/* 3. DYNAMIC TAB DETAILS VIEW */}
        {activeReportTab === 'attendance' && (
          <div className="space-y-4 pt-2">
            <div className="p-4 rounded-2xl bg-black/30 border border-white/5 flex justify-between items-center text-xs">
              <span className="font-bold text-white uppercase tracking-wider">Worship Turnout & Consistency Breakdown</span>
              <span className="text-orange-400 font-mono font-bold">Sunday Average: 541 Attendees</span>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-4 rounded-2xl bg-slate-900 border border-white/5 space-y-1">
                <span className="text-xs text-slate-400">1st Morning Worship Service</span>
                <div className="text-xl font-black text-white font-mono">245 Believers</div>
                <span className="text-[10px] text-emerald-400 font-bold">88% Capacity (Peak Service)</span>
              </div>
              <div className="p-4 rounded-2xl bg-slate-900 border border-white/5 space-y-1">
                <span className="text-xs text-slate-400">2nd English & Youth Worship</span>
                <div className="text-xl font-black text-white font-mono">165 Believers</div>
              ...
              <div className="p-4 rounded-2xl bg-slate-900 border border-white/5 space-y-1">
                ...
                <div className="text-xl font-black text-white font-mono">131 Children</div>
        ...
        {activeReportTab === 'members' && (
          <div className="space-y-4 pt-2">
            <div className="p-4 rounded-2xl bg-black/30 border border-white/5 flex justify-between items-center text-xs">
              ...
              <span className="text-sky-400 font-mono font-bold">{totalFamiliesCount} Registered Families</span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
              ...
              <div className="p-4 rounded-2xl bg-slate-900 border border-white/5 text-center">
                ...
                <div className="text-2xl font-black text-orange-400 font-mono mt-1">68</div>
              </div>
              <div className="p-4 rounded-2xl bg-slate-900 border border-white/5 text-center">
        ...
        {activeReportTab === 'visitors' && (
          <div className="space-y-4 pt-2">
            <div className="p-4 rounded-2xl bg-black/30 border border-white/5 flex justify-between items-center text-xs">
              ...
              <span className="text-rose-400 font-mono font-bold">Conversion Rate: 33.3%</span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="p-4 rounded-2xl bg-slate-900 border border-white/5 space-y-1">
                <span className="text-xs text-slate-400">Full Church Membership</span>
        ...
        {activeReportTab === 'finance' && (
          <div className="space-y-4 pt-2">
            <div className="p-4 rounded-2xl bg-black/30 border border-white/5 flex justify-between items-center text-xs">
              ...
              <span className="text-emerald-400 font-mono font-bold">Net Surplus: +₹79,500</span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-4 rounded-2xl bg-slate-900 border border-emerald-500/20 space-y-1">
                ...
                <div className="text-2xl font-black text-emerald-400 font-mono">₹1,42,500</div>
              </div>
              <div className="p-4 rounded-2xl bg-slate-900 border border-rose-500/20 space-y-1">
                <span className="text-xs text-slate-400">Church Operating Expenses</span>
                <div className="text-2xl font-black text-rose-400 font-mono">₹63,000</div>
              </div>
              <div className="p-4 rounded-2xl bg-slate-900 border border-sky-500/20 space-y-1">
                <span className="text-xs text-slate-400">Building Fund Reserves</span>
                <div className="text-2xl font-black text-sky-400 font-mono">₹4,12,000</div>
              </div>
            </div>
          </div>
        )}
        ...
        {activeReportTab === 'certificates' && (
          <div className="space-y-4 pt-2">
            <div className="p-4 rounded-2xl bg-black/30 border border-white/5 flex justify-between items-center text-xs">
              ...
              <span className="text-indigo-400 font-mono font-bold">Standard PDF Templates</span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-4 rounded-2xl bg-slate-900 border border-white/10 space-y-2">
                ...
                <p className="text-[11px] text-slate-400">Official sacrament certification with pastoral seal and scripture verse.</p>
                <button
                  type="button"
                  onClick={() => handleOpenPreview('baptism', 'WATER BAPTISM SACRAMENT CERTIFICATE')}
                  className="w-full py-2 bg-indigo-600/20 hover:bg-indigo-600/30 text-indigo-300 border border-indigo-500/30 rounded-xl text-xs font-bold cursor-pointer"
                >
                  Preview & Print
                </button>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-slate-900 border border-white/10 space-y-2">
                ...
                <p className="text-[11px] text-slate-400">Infant and child dedication blessing certificate for family records.</p>
                <button
                  type="button"
                  onClick={() => handleOpenPreview('dedication', 'CHILD DEDICATION BLESSING CERTIFICATE')}
                  className="w-full py-2 bg-rose-600/20 hover:bg-rose-600/30 text-rose-300 border border-rose-500/30 rounded-xl text-xs font-bold cursor-pointer"
                >
                  Preview & Print
                </button>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-slate-900 border border-white/10 space-y-2">
                ...
                <p className="text-[11px] text-slate-400">Character reference and bona fide letter for employment or admissions.</p>
                <button
                  type="button"
                  onClick={() => handleOpenPreview('recommendation', 'OFFICIAL PASTORAL RECOMMENDATION LETTER')}
                  className="w-full py-2 bg-emerald-600/20 hover:bg-emerald-600/30 text-emerald-300 border border-emerald-500/30 rounded-xl text-xs font-bold cursor-pointer"
                >
                  Preview & Print
                </button>
              </div>
      ...
      {/* 4. LIVE DOCUMENT PREVIEW & PDF PRINT ENGINE MODAL */}
          ...
          <div className="w-full max-w-2xl bg-white text-slate-900 rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="bg-slate-900 px-6 py-3.5 flex items-center justify-between text-white border-b border-white/10">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="px-4 py-1.5 bg-orange-500 hover:bg-orange-600 text-white rounded-xl text-xs font-bold shadow-md cursor-pointer flex items-center gap-1.5"
                >
                  <Printer size={13} />
            ...
            <div className="p-8 overflow-y-auto space-y-6 bg-white select-text">
              ...
              <div className="border-b-2 border-slate-900 pb-4 text-center space-y-1">
                ...
                <p className="text-[10px] text-slate-500 font-mono">Ref No: {previewDocument.refNo} | Date of Issue: {previewDocument.date}</p>
              </div>
                ...
                <div className="space-y-4 text-xs text-slate-700 leading-relaxed">
                  ...
                  <div className="grid grid-cols-2 gap-4 p-4 bg-slate-50 border border-slate-200 rounded-xl">
                    <div>
                      ...
                      <strong className="text-base text-emerald-700 font-mono">₹1,42,500 INR</strong>
                    </div>
                    <div>
                      <span className="text-[10px] uppercase font-bold text-slate-500 block">Disbursed Expenses</span>
                      <strong className="text-base text-rose-700 font-mono">₹63,000 INR</strong>
                    </div>
                  </div>
              ...
              {previewDocument.type === 'baptism' && (
                <div className="space-y-4 text-center py-4 text-xs text-slate-700 leading-relaxed">
                  ...
                  <p className="pt-2">This is to certify that candidate has been publicly baptized by water immersion in confession of faith in the Lord Jesus Christ.</p>
